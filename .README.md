...
- **Logos de canal**: por defecto un cuadradito con iniciales y color derivado del
  nombre. Para usar imágenes reales, añade rutas en `LOGOS_CANAL`
  (p.ej. `"DAZN (Ver en directo)":"assets/canales/dazn.png"`).
